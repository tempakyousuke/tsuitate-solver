...
/// 1問を解いて結果を表示するヘルパー（DFS版）
fn run_question_dfs(number: u32, max_depth: u32, time_limit_secs: u64) {
    let path = sample_questions_dir().join(format!("{}.json", number));
    let pos = load_question(&path);

    println!("=== 問題 {} (DFS) ===", number);
    print_position(&pos);

    let meta = MetaPosition::new(pos);
    let cancel = cancel_after(time_limit_secs);

    let mut solver = DfsTsuitateSolver::new(max_depth, cancel);
    ...
    println!(
        "問題{} (DFS): found={}, depth={}, time={:.3}s, nodes={}, msg={}",
        number,
        result.found,
...
#[test]
#[ignore]
fn dfs_bench_question_01() {
    run_question_dfs(1, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_02() {
    run_question_dfs(2, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_03() {
    run_question_dfs(3, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_04() {
    run_question_dfs(4, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_05() {
    run_question_dfs(5, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_06() {
    run_question_dfs(6, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_07() {
    run_question_dfs(7, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_08() {
    run_question_dfs(8, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_09() {
    run_question_dfs(9, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_10() {
    run_question_dfs(10, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_11() {
    run_question_dfs(11, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_12() {
    run_question_dfs(12, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_13() {
    run_question_dfs(13, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_14() {
    run_question_dfs(14, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_15() {
    run_question_dfs(15, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_16() {
    run_question_dfs(16, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_17() {
    run_question_dfs(17, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_18() {
    run_question_dfs(18, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_19() {
    run_question_dfs(19, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_20() {
    run_question_dfs(20, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_21() {
    run_question_dfs(21, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_22() {
    run_question_dfs(22, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_23() {
    run_question_dfs(23, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_24() {
    run_question_dfs(24, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_25() {
    run_question_dfs(25, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_26() {
    run_question_dfs(26, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_27() {
    run_question_dfs(27, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_28() {
    run_question_dfs(28, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_29() {
    run_question_dfs(29, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_30() {
    run_question_dfs(30, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_31() {
    run_question_dfs(31, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_32() {
    run_question_dfs(32, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_33() {
    run_question_dfs(33, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_34() {
    run_question_dfs(34, 17, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_35() {
    run_question_dfs(35, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_36() {
    run_question_dfs(36, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_37() {
    run_question_dfs(37, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_38() {
    run_question_dfs(38, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_39() {
    run_question_dfs(39, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_40() {
    run_question_dfs(40, 15, 60);
}

#[test]
#[ignore]
fn dfs_bench_question_41() {
    run_question_dfs(41, 15, 60);
}

/// 全問一括ベンチマーク（サマリー表付き）
/// cargo test --release --test dfs_benchmark_tests dfs_bench_all_questions -- --ignored --nocapture
#[test]
#[ignore]
fn dfs_bench_all_questions() {
    ...
    println!("=== DFS全問ベンチマーク (default_max_depth={}, time_limit={}s) ===\n", default_max_depth, time_limit_secs);
    ...
    let output_path = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        .parent()
        .unwrap()
        .join("dfs-benchmark-results.md");

    let now = chrono::Local::now();
    let mut md = String::new();
    md.push_str("# DFSベンチマーク結果\n\n");
    md.push_str(&format!("- 実行日時: {}\n", now.format("%Y-%m-%d %H:%M:%S")));
    md.push_str(&format!("- ソルバー: DfsTsuitateSolver\n"));
    ...
    println!("\nDFSベンチマーク結果を {} に出力しました", output_path.display());
}
